...
public class RPSLSpock {
    ...
    /**
     * This method checks to see if the choice the user wants to pick is a valid input
    *@param  pick represents which of the choices was picked
     */
    ...
    /**
     * Generates a random pick for the computer
     * @return returns the random pick
     */
     ...
     * @param c_pick
     * @param h_pick
     * @return returns true or false based on whether or not the computer won
     */
